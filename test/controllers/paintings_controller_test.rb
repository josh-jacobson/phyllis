...
class PaintingsControllerTest < ActionController::TestCase
  ...
  test "should create painting" do
    assert_difference('Painting.count') do
      post :create, painting: { category: @painting.category, description: @painting.description, filename: @painting.filename, size: @painting.size, title: @painting.title }
    end
  ...
  test "should update painting" do
    patch :update, id: @painting, painting: { category: @painting.category, description: @painting.description, filename: @painting.filename, size: @painting.size, title: @painting.title }
    assert_redirected_to painting_path(assigns(:painting))
  end
